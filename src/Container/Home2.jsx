...
let prods = "";
function Home2({ products }) {
  useEffect(() => {
    console.log("products are: ", Array.isArray(products));
      ...
      <div className="col-lg-4 col-md-6 text-center">
        <div className="single-product-item">
          ...
          <p className="product-price">
            <span>
              {product.categories.length > 0 &&
              product.categories[0].name === "Fruits"
                ? "yes"
                : "no"}
            </span>{" "}
            85${" "}
                ...
                <>
                  {products.map((product) => {
                    return product.categories.length > 0 &&
                      product.categories.name == "Fruits" ? (
                      <div className="col-lg-4 col-md-6 text-center">
                        <div className="single-product-item">
                          <div className="product-image">
                            <a href="/SingleProduct">
              ...
              <div className="content-column col-lg-6">
                ...
                <div className="time-counter">
                  <div
                    ...
                    data-countdown="2023/2/01"
                  >
                    <div className="counter-column">
                      <div className="inner">
                        <span className="count">100</span>Days
                      </div>
                    </div>{" "}
                    <div className="counter-column">
                      <div className="inner">
...
export default connect(mapToState)(Home2);
